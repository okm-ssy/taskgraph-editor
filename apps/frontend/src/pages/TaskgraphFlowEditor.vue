<template>
  <div class="w-full h-screen flex flex-col p-4">
    <h2 class="font-bold text-xl mb-4">タスクグラフツール (Vue Flow)</h2>
    ...
    <FlowEditor :read-only="isReadOnlyMode" class="flex-1 min-h-0" />
...
import FlowEditor from '../components/vue-flow/FlowEditor.vue';
import {
  PROJECT_CONSTANTS,
  STORAGE_KEYS,
  IS_READONLY_MODE,
